...
from src.ml.utils.feature_engineering import preprocess_si_gt8_classification
...
# Запускаем обработку всех моделей для решения задачи классификации SI больше 8.
